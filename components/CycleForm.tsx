...
export default function CycleForm({ onClose, onSuccess, editCycle }: CycleFormProps) {
  ...
  useEffect(() => {
    if (editCycle) {
      setFormData({
        periodStartDate: editCycle.periodStartDate.split('T')[0],
        periodEndDate: editCycle.periodEndDate ? editCycle.periodEndDate.split('T')[0] : '',
        flowIntensity: editCycle.flowIntensity || '',
        cramps: editCycle.cramps !== null ? String(editCycle.cramps) : '',
        bloating: editCycle.bloating !== null ? String(editCycle.bloating) : '',
        moodSwings: editCycle.moodSwings !== null ? String(editCycle.moodSwings) : '',
